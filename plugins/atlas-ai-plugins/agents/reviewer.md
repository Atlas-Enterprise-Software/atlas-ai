...
1. Read the spec, the changes summary, and the test results from `.ship/`.
...
4. Write a verdict to `.ship/review.md`: `VERDICT: SHIP / NEEDS WORK / BLOCK`. For NEEDS WORK or BLOCK, list exactly what to fix and where.
